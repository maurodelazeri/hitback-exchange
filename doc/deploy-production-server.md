...
##### Clone the Source
    ...
    mkdir -p ~/hitback
    git clone git://github.com/hitback/hitback.git ~/hitback/current
    cd hitback/current
...
**Passenger:**
    ...
    sudo ln -s /home/deploy/hitback/current/config/nginx.conf /etc/nginx/conf.d/hitback.conf
